...
# Архитектурный стиль REST (REpresentaion State Transfer
# /news (GET) - все новости
# /news/2 (GET) - новость 2
# news (POST) - создание новой новости
# /news/2 (PUT) -изменить новость 2
# /news/2 (DELETE) - удалить новость 2
# RESTful - приложение
...
@blueprint.route('/api/news/<int:new_id>', methods=['DELETE'])
